...
class Car(db.Model):
    ...
    kmbuy = db.Column(db.Integer, nullable=False, default=0)
    kmtot = db.Column(db.Integer, nullable=True, default=0)
...
class CarCostProfile(db.Model):
    ...
    notes = db.Column(db.String(200), nullable=True)
    perkm = db.Column(db.Float, nullable=True)
...
class Event(db.Model):
    ...
    totcostkm = db.Column(db.Float, nullable=True)
    totcostact = db.Column(db.Integer, nullable=True)
    totcostspares = db.Column(db.Integer, nullable=True)
    ccp_id = db.Column(db.Integer, db.ForeignKey('CarCostProfile.id'), nullable=True)
    car_id = db.Column(db.Integer, db.ForeignKey('car.id'), nullable=False)
